...
public class HorNumberPicker extends LinearLayout{
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
            ...
            if(Math.abs(velocityTracker.getXVelocity()) > mMinimumFlingVelocity){//发生fling动作
            	mScroller.fling(0, 0, (int) velocityTracker.getXVelocity(), 0, Integer.MIN_VALUE, Integer.MAX_VALUE, 0, 0);
            	invalidate();
            }
	...
	public void setValueChangeListener(OnValueChangedListener valueChangeListener) {
